...
class PermissaoController{
    ...
    public function insertPermissao($padrao){
        ...
        if(isset($_POST['pfPromocoesC'])) $pfPromocoesC = "C";
        if(isset($_POST['pfPromocoesR'])) $pfPromocoesR = "R";
        if(isset($_POST['pfPromocoesU'])) $pfPromocoesU = "U";
        if(isset($_POST['pfPromocoesD'])) $pfPromocoesD = "D";
        ...
        if(isset($_POST['pfProdutoC'])) $pfProdutoC = "C";
        if(isset($_POST['pfProdutoR'])) $pfProdutoR = "R";
        if(isset($_POST['pfProdutoU'])) $pfProdutoU = "U";
        if(isset($_POST['pfProdutoD'])) $pfProdutoD = "D";
        ...
        if(isset($_POST['cmsUserC'])) $cmsUserC = "C";
        if(isset($_POST['cmsUserR'])) $cmsUserR = "R";
        if(isset($_POST['cmsUserU'])) $cmsUserU = "U";
        if(isset($_POST['cmsUserD'])) $cmsUserD = "D";
