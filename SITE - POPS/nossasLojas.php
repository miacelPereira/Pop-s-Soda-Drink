...
<head>
    ...
    <link rel="stylesheet" type="text/css" media="screen" href="CSS/lojas.css" />
        ...
        function loadList(){
            $.ajax({
                type: "GET",
                url: "list_content/list_nossasLojas.php",
                success: function(dados){
                    $(".list_nossasLojas").html(dados)
                }
            });
        }
        ...
        function loadUrl(idRegistro){
            $.ajax({
                ...
                data: {id:idRegistro},
                success: function(dados){
                    $(".list_urlMaps").html(dados)
                }
            });
        }

        function pesquisa(){
            let txtPesquisa = $('#txtPesquisa').val();
            $.ajax({
                type: "GET",
                url: "list_content/list_pesquisaLojas.php",
                data: {pesquisa:txtPesquisa},
                success: function(dados){
                    $(".list_nossasLojas").html(dados)
                }
            });
    ...
    <div id="container1">
        ...
        <!--  começo do conteudo-->
            <section class="conteudo-corpo">
                ...
                <div class="caixa-bebida">
                    <div class="caixa-titulo">
                        ENCONTRE UMA LOJA MAIS PRÓXIMA A VOCÊ
                    </div>
                    
                    <div class="caixa-pesquisa">
                    
                    <form name="frmBusca" method="get" action="">
                        <input type="search" id="txtPesquisa"  autocomplete="on" name="txtPesquisa" placeholder="Digite o nome da cidade">
                        <input type="button" name="btnCidade" id="btnCidade" value="Pesquisar" onclick="pesquisa()">
                    </form>
                    </div> 
                    <div class="list_nossasLojas"></div>  
                    <div class="list_urlMaps"></div>
                </div>
            </section>
